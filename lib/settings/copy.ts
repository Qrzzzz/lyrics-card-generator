...
const en = {
  ...
  darkAcrylic: "Dark Acrylic", lightAcrylic: "Light Acrylic",
  ...
  backgroundImageSelected: "Background image selected. Save to keep it.", backgroundImageFailed: "Could not load the background image.",
  backgroundSaveFailed: "Settings were saved, but an old background file could not be removed.", backgroundResetPending: "Background reset pending. Save to apply it.",
  customThemeIncomplete: "Complete the custom theme colors to keep text readable.", themeCustom: "Custom"
};
...
const zh: Copy = {
  ...
  darkAcrylic: "深色亚克力", lightAcrylic: "浅色亚克力",
  ...
  clearAll: "一键清空", clearAllDescription: "清空歌曲内容并保留软件设置。", backgroundImageSelected: "已选择背景图片，保存后生效。",
  backgroundImageFailed: "背景图片读取失败。", backgroundSaveFailed: "设置已保存，但旧背景图片清理失败。", backgroundResetPending: "背景已在草稿中重置，保存后生效。",
  customThemeIncomplete: "请补齐自定义主题颜色以确保文字可读。", themeCustom: "自定义"
};

export const settingsCopy: Record<Locale, Copy> = {
  zh, "zh-TW": { ...zh, settings: "設定", description: "個人化軟體介面，不影響匯出的歌詞卡片。", general: "一般", appearance: "外觀", background: "背景", export: "匯出", language: "語言", save: "儲存", cancel: "取消", exampleLoaded: "已載入範例", clearAll: "一鍵清空", clearAllDescription: "清空歌曲內容並保留軟體設定。", backgroundImageSelected: "已選擇背景圖片，儲存後生效。", backgroundImageFailed: "背景圖片讀取失敗。", backgroundSaveFailed: "設定已儲存，但舊背景圖片清理失敗。", backgroundResetPending: "背景已在草稿中重設，儲存後生效。", darkAcrylic: "深色壓克力", lightAcrylic: "淺色壓克力", acrylicSupportNote: "壓克力主題使用 Windows 原生視窗材質，需要 Windows 11 22H2 或更新版本；其他系統會降級為可讀的透明介面。", customThemeIncomplete: "請補齊自訂主題顏色以確保文字可讀。", themeCustom: "自訂" },
  en,
  fr: { ...en, settings: "Paramètres", general: "Général", appearance: "Apparence", background: "Arrière-plan", export: "Exportation", about: "À propos", language: "Langue", save: "Enregistrer", cancel: "Annuler", example: "Exemple", examples: "Exemples", darkAcrylic: "Acrylique sombre", lightAcrylic: "Acrylique clair", acrylicSupportNote: "Acrylic utilise le matériau de fenêtre natif de Windows et nécessite Windows 11 22H2 ou une version ultérieure ; les autres systèmes utilisent une interface transparente lisible.", clearAll: "Tout effacer", clearAllDescription: "Effacer la chanson tout en conservant les paramètres.", backgroundImageSelected: "Image d’arrière-plan sélectionnée. Enregistrez pour la conserver.", backgroundImageFailed: "Impossible de charger l’image d’arrière-plan.", backgroundSaveFailed: "Les paramètres sont enregistrés, mais l’ancien arrière-plan n’a pas pu être supprimé.", backgroundResetPending: "Réinitialisation en attente. Enregistrez pour l’appliquer.", customThemeIncomplete: "Complétez les couleurs du thème personnalisé.", themeCustom: "Personnalisé" },
  ja: { ...en, settings: "設定", general: "一般", appearance: "外観", background: "背景", export: "書き出し", about: "このアプリについて", language: "言語", save: "保存", cancel: "キャンセル", example: "サンプル", examples: "サンプル", darkAcrylic: "ダークアクリル", lightAcrylic: "ライトアクリル", acrylicSupportNote: "アクリルテーマは Windows のネイティブなウィンドウ素材を使用し、Windows 11 22H2 以降が必要です。他の環境では読みやすい透明インターフェイスにフォールバックします。", clearAll: "すべて消去", clearAllDescription: "設定を保持したまま曲の内容を消去します。", backgroundImageSelected: "背景画像を選択しました。保存すると反映されます。", backgroundImageFailed: "背景画像を読み込めませんでした。", backgroundSaveFailed: "設定は保存されましたが、古い背景画像を削除できませんでした。", backgroundResetPending: "背景のリセットは保留中です。保存すると反映されます。", customThemeIncomplete: "文字を読みやすくするため、カスタムテーマの色を設定してください。", themeCustom: "カスタム" },
  es: { ...en, settings: "Ajustes", general: "General", appearance: "Apariencia", background: "Fondo", export: "Exportar", about: "Acerca de", language: "Idioma", save: "Guardar", cancel: "Cancelar", example: "Ejemplo", examples: "Ejemplos", darkAcrylic: "Acrílico oscuro", lightAcrylic: "Acrílico claro", acrylicSupportNote: "Acrylic usa el material de ventana nativo de Windows y requiere Windows 11 22H2 o posterior; otros sistemas usan una interfaz transparente legible.", clearAll: "Borrar todo", clearAllDescription: "Borra la canción y conserva los ajustes.", backgroundImageSelected: "Imagen de fondo seleccionada. Guarda para conservarla.", backgroundImageFailed: "No se pudo cargar la imagen de fondo.", backgroundSaveFailed: "Los ajustes se guardaron, pero no se pudo eliminar el fondo anterior.", backgroundResetPending: "Restablecimiento pendiente. Guarda para aplicarlo.", customThemeIncomplete: "Completa los colores del tema personalizado.", themeCustom: "Personalizado" }
};

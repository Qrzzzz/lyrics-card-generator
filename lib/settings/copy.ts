...
const en = {
  ...
  exportDescription: "Choose the default quality for saved images.",
...
const zh: Copy = {
  ...
  exportDescription: "选择保存图片时使用的默认质量。", aiDescription: "连接兼容服务并配置歌词翻译。",

...
export const settingsCopy: Record<Locale, Copy> = {
  ...
  ja: { ...en, settings: "設定", general: "一般", appearance: "外観", background: "背景", export: "書き出し", about: "このアプリについて", language: "言語", save: "保存", cancel: "キャンセル", example: "サンプル", examples: "サンプル", darkAcrylic: "ダークアクリル", lightAcrylic: "ライトアクリル", acrylicSupportNote: "アクリルテーマは Windows のネイティブなウィンドウ素材を使用し、Windows 11 22H2 以降が必要です。他の環境では読みやすい透明インターフェイスにフォールバックします。", clearAll: "すべて消去", clearAllDescription: "設定を保持したまま曲の内容を消去します。", backgroundImageSelected: "背景画像を保存しました", backgroundImageFailed: "背景画像を読み込めませんでした。", backgroundSaveFailed: "設定は保存されましたが、古い背景画像を削除できませんでした。", backgroundResetPending: "背景をリセットしました", customThemeIncomplete: "文字を読みやすくするため、カスタムテーマの色を設定してください。", themeCustom: "カスタム" },

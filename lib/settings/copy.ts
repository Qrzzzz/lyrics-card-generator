...
export const settingsCopy: Record<Locale, Copy> = {
  zh, "zh-TW": { ...zh, settings: "設定", description: "個人化軟體介面，不影響匯出的歌詞卡片。", general: "一般", appearance: "外觀", background: "背景", export: "匯出", language: "語言", save: "儲存", cancel: "取消", exampleLoaded: "已載入範例", originalLanguage: "原語言", translationLanguage: "譯文語言", clearAll: "一鍵清空", clearAllDescription: "清空歌曲內容並保留軟體設定。", backgroundImageSelected: "背景圖片已儲存", backgroundImageFailed: "背景圖片讀取失敗。", backgroundSaveFailed: "設定已儲存，但舊背景圖片清理失敗。", backgroundResetPending: "背景已重設", darkAcrylic: "深色壓克力", lightAcrylic: "淺色壓克力", acrylicSupportNote: "壓克力主題使用 Windows 原生視窗材質，需要 Windows 11 22H2 或更新版本；其他系統會降級為可讀的透明介面。", customThemeIncomplete: "請補齊自訂主題顏色以確保文字可讀。", themeCustom: "自訂" },
  en,
  fr: { ...en, settings: "Paramètres", general: "Général", appearance: "Apparence", background: "Arrière-plan", export: "Exportation", about: "À propos", language: "Langue", save: "Enregistrer", cancel: "Annuler", example: "Exemple", examples: "Exemples", originalLanguage: "Langue source", translationLanguage: "Traduction", darkAcrylic: "Acrylique sombre", lightAcrylic: "Acrylique clair", acrylicSupportNote: "Acrylic utilise le matériau de fenêtre natif de Windows et nécessite Windows 11 22H2 ou une version ultérieure ; les autres systèmes utilisent une interface transparente lisible.", clearAll: "Tout effacer", clearAllDescription: "Effacer la chanson tout en conservant les paramètres.", backgroundImageSelected: "Image d’arrière-plan enregistrée", backgroundImageFailed: "Impossible de charger l’image d’arrière-plan.", backgroundSaveFailed: "Les paramètres sont enregistrés, mais l’ancien arrière-plan n’a pas pu être supprimé.", backgroundResetPending: "Arrière-plan réinitialisé", customThemeIncomplete: "Complétez les couleurs du thème personnalisé.", themeCustom: "Personnalisé" },
  ja: { ...en, settings: "設定", general: "一般", appearance: "外観", background: "背景", export: "書き出し", about: "このアプリについて", language: "言語", save: "保存", cancel: "キャンセル", example: "サンプル", examples: "サンプル", originalLanguage: "原文言語", translationLanguage: "翻訳", darkAcrylic: "ダークアクリル", lightAcrylic: "ライトアクリル", acrylicSupportNote: "アクリルテーマは Windows のネイティブなウィンドウ素材を使用し、Windows 11 22H2 以降が必要です。他の環境では読みやすい透明インターフェイスにフォールバックします。", clearAll: "すべて消去", clearAllDescription: "設定を保持したまま曲の内容を消去します。", backgroundImageSelected: "背景画像を保存しました", backgroundImageFailed: "背景画像を読み込めませんでした。", backgroundSaveFailed: "設定は保存されましたが、古い背景画像を削除できませんでした。", backgroundResetPending: "背景をリセットしました", customThemeIncomplete: "文字を読みやすくするため、カスタムテーマの色を設定してください。", themeCustom: "カスタム" },
  es: { ...en, settings: "Ajustes", general: "General", appearance: "Apariencia", background: "Fondo", export: "Exportar", about: "Acerca de", language: "Idioma", save: "Guardar", cancel: "Cancelar", example: "Ejemplo", examples: "Ejemplos", originalLanguage: "Idioma original", translationLanguage: "Traducción", darkAcrylic: "Acrílico oscuro", lightAcrylic: "Acrílico claro", acrylicSupportNote: "Acrylic usa el material de ventana nativo de Windows y requiere Windows 11 22H2 o posterior; otros sistemas usan una interfaz transparente legible.", clearAll: "Borrar todo", clearAllDescription: "Borra la canción y conserva los ajustes.", backgroundImageSelected: "Imagen de fondo guardada", backgroundImageFailed: "No se pudo cargar la imagen de fondo.", backgroundSaveFailed: "Los ajustes se guardaron, pero no se pudo eliminar el fondo anterior.", backgroundResetPending: "Fondo restablecido", customThemeIncomplete: "Completa los colores del tema personalizado.", themeCustom: "Personalizado" }
};

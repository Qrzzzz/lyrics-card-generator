...
<p>
  ...
  <a href="./docs/releases/v6.1.0.es.md">Notas de la versión</a> ·
...
Descarga v6.1.0 desde [GitHub Releases](https://github.com/Qrzzzz/lyrics-card-generator/releases/latest):

* Instalador: `Lyrics Card Generator Setup 6.1.0.exe`
* Versión portable: `Lyrics Card Generator-6.1.0-portable.exe`
...
* La selección de fuentes personalizadas se mueve de la superposición interna a una ventana secundaria de Electron con barra de título del sistema.
* Se mantienen la búsqueda, las recomendaciones, la lista completa de fuentes y las vistas previas; la selección continúa actualizando al instante la tarjeta real.
* La ventana usa una identidad IPC mínima e independiente, mientras Web Lite conserva una alternativa compatible con el navegador.

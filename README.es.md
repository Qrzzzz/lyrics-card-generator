...
<p>
  ...
  <a href="./docs/releases/v5.5.1.es.md">Notas de la versión</a> ·
...
* Instalador recomendado: `Lyrics Card Generator Setup 5.5.1.exe`
* Versión portable: `Lyrics Card Generator-5.5.1-portable.exe`
...
### Aspectos destacados de la versión 5.5.1

* Las nuevas tarjetas verticales personalizadas empiezan con Ancho automático activado y eligen un ancho cómodo solo a partir del contenido actual y la composición real del navegador con la fuente final.
* El interlineado ahora abarca de 1,5 a 2,1, con 1,8 como valor predeterminado para las tarjetas nuevas.

...
### Aspectos destacados de la versión 5.9.1
...
* El guardado siempre es explícito: no hay guardado automático ni un nuevo atajo `Ctrl+S`. Web Lite mantiene su interfaz y comportamiento actuales.

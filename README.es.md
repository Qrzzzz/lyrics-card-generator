...
<p>
  ...
  <a href="./docs/releases/v6.2.6.es.md">Notas de la versión</a> ·
...
> v6.2.6 aún no publicado; el estado actual del repositorio es un candidato local.
...
* Se eliminan las amplias máscaras locales de legibilidad detrás de los metadatos, las letras y el pie para evitar grandes manchas oscuras.
* El texto conserva solo una sombra ajustada y tenue, mientras que la portada usa una sombra más pequeña y discreta para flotar suavemente sobre el fondo.
* La combinación tipográfica personalizada adopta la misma tarjeta de una sola capa que los dos preajustes, sin panel anidado; la indicación redundante de crecimiento automático sigue eliminada.

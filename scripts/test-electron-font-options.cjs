...
const options = normalizeFontOptions([
  ...
  { label: "Mona Sans 斜体", family: "Mona Sans", fontWeight: 700, fontStyle: "italic" },
...
assert(options.some((option) => option.label === "Mona Sans 斜体" && option.fontStyle === "italic"), "preserves italic style");

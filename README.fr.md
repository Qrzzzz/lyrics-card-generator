...
<p>
  ...
  <a href="./docs/releases/v5.10.0.fr.md">Notes de version</a> ·
...
La v5.10.0 est une candidate locale (statut : pas encore publié). Après validation, elle sera disponible sur [GitHub Releases](https://github.com/Qrzzzz/lyrics-card-generator/releases/latest) :

* Installateur : `Lyrics Card Generator Setup 5.10.0.exe`
* Version portable : `Lyrics Card Generator-5.10.0-portable.exe`

L'installateur est recommandé pour une utilisation régulière. La version portable convient aux essais, à une utilisation temporaire ou à un disque amovible.

> La version actuelle n'est pas signée. Windows peut afficher un avertissement SmartScreen, ce qui est courant pour une application personnelle non signée.

### Points forts de la v5.10.0

* Une palette perceptuelle analyse toute la pochette tout en conservant la position, la surface, la luminance, la saillance et une graine stable pour chaque couleur.
* Des ancres spatiales adaptées au format fusionnent en un champ doux et continu, sans contours en S fixes, bandes parallèles ni simples taches radiales.
* Les zones de paroles reçoivent un contrôle local de la luminance et du contraste au lieu d’un voile sombre uniforme.
* L’aperçu, l’export et Web Lite partagent un rendu déterministe, stable pour chaque pochette et recomposé pour les formats portrait, paysage et très allongés.

...
<p>
  ...
  <a href="./docs/releases/v5.10.1.zh-CN.md">发布说明</a> ·
...
请从 [GitHub Releases](https://github.com/Qrzzzz/lyrics-card-generator/releases/latest) 下载 v5.10.1：

* 安装版：`Lyrics Card Generator Setup 5.10.1.exe`
* 便携版：`Lyrics Card Generator-5.10.1-portable.exe`
...
* 按封面可见面积约束颜色家族的锚点数量与总能量，保持主导色系。
* 为小面积高饱和高光设置明确扩张上限，避免其反转整张背景的冷暖关系。
* 边缘锚点也使用封面来源家族，色差优化只在已分配预算内进行。
* 相同宽高比保持一致颜色角色；编辑预览、导出与 Web Lite 共用修复后的确定性渲染流程。

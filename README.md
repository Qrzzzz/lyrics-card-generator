...
感谢 [Sakuramble](https://github.com/Sakuramble) 对 [v1.1.0](https://github.com/Qrzzzz/lyrics-card-generator/releases/tag/v1.1.0) 更新说明提出建议，提醒将致谢和发布说明对应到本次维护更新中的代码瘦身、编辑器拆分、桌面版导出修复、字体打包修复和 Windows 构建流程整理。

...
<p>
  ...
  <a href="./docs/releases/v6.2.10.zh-TW.md">發布說明</a> ·
...
從 [GitHub Releases](https://github.com/Qrzzzz/lyrics-card-generator/releases/tag/v6.2.10) 下載 v6.2.10，Windows 安裝程式名稱為：

* Windows x64 安裝版：`Lyrics.Card.Generator.Setup.6.2.10.exe`
...
* 修復匯入等待取代確認或自動草稿補存時，舊操作可能覆蓋新連結、歌詞或文件的問題。
* AI 翻譯與連線測試統一拒絕 HTTP 重新導向，避免將請求本文轉送至未授權的下一站。
* 為已驗證的備用網路位址保留首個回應的等待時間，避免無回應的首個位址耗盡整次請求的逾時預算。

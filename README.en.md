...
Thanks to [Sakuramble](https://github.com/Sakuramble) for suggestions on the [v1.1.0](https://github.com/Qrzzzz/lyrics-card-generator/releases/tag/v1.1.0) release notes, especially tying the acknowledgement and release wording to the actual maintenance work: code slimming, editor modularization, desktop export fixes, font packaging fixes, and Windows build workflow cleanup.

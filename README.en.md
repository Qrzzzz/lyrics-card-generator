...
<p>
  ...
  <a href="./docs/releases/v5.1.0.en.md">Release Notes</a> ·
...
* Recommended installer: `Lyrics Card Generator Setup 5.1.0.exe`
* Portable version: `Lyrics Card Generator-5.1.0-portable.exe`
...
* All untrusted song and image URLs use per-hop Safe Fetch validation, blocking redirects to private, reserved, and cloud-metadata addresses.
* Song, lyric, and example imports are atomic; clear, song replacement, and newer intents invalidate older requests and candidates.
* Desktop export uses an immutable snapshot and synchronous mutex, keeping content, dimensions, and filename on one revision.
* Web Lite uses an independent export host and shares the desktop 36-line, font, size-stability, and overflow safety checks.

...
<p>
  ...
  <a href="./docs/releases/v5.8.0.en.md">Release Notes</a> ·
...
* Recommended installer: `Lyrics Card Generator Setup 5.8.0.exe`
* Portable version: `Lyrics Card Generator-5.8.0-portable.exe`
...
* Adds an approximately 44 px command bar to step two with the active panel and cursor line plus undo/redo, blank-line cleanup, Find, AI translation, and the clickable 36-line budget.
* Stabilizes the right sidebar into Cleanup, Translation, Review, and Source tabs. Selection-first scope, aligned two-column blank cleanup, previews for risky actions, and immediate undo prevent silent destructive edits.
* Keeps one shared editor scroll and selection anchors. The desktop sidebar remains resizable/collapsible, while narrow screens use an overlay drawer that does not squeeze the lyrics. The main Stepper is unchanged.

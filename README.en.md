...
<p>
  ...
  <a href="./docs/releases/v4.3.0.en.md">Release Notes</a> ·
...
* Recommended installer: `Lyrics Card Generator Setup 4.3.0.exe`
* Portable version: `Lyrics Card Generator-4.3.0-portable.exe`

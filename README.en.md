...
<p>
  ...
  <a href="./docs/releases/v4.3.2.en.md">Release Notes</a> ·
...
* Recommended installer: `Lyrics Card Generator Setup 4.3.2.exe`
* Portable version: `Lyrics Card Generator-4.3.2-portable.exe`
...
* Explicit Badge now uses a `currentColor` SVG cutout instead of a rendered E glyph, matching between preview and PNG export.
* Portrait headers enlarge the cover and vertically center song info so the cover, title, artist, and album form a steadier visual center.
* Title-to-badge spacing and vertical alignment were tuned so the marker feels closer to Apple Music's translucent geometric badge.
